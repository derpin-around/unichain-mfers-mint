				...
				<CardContent className="pt-6">
					...
					<div className="flex items-center justify-between mb-4">
						...
						<div className="text-base pr-1 font-semibold dark:text-white">
							total: {props.pricePerToken * quantity} {toLowerCase(props.currencySymbol)} ({.00042 * quantity} {toLowerCase(props.currencySymbol)} for mfers, tinyass unicorns, and based space punks holders)
						</div>
					</div>
