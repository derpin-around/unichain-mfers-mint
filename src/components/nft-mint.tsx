				...
				<CardContent className="pt-6">
					...
					<div className="flex items-center justify-center mb-4 text-center w-full">
						<div className="text-base dark:text-white">
							(🤝 only <span style={{fontFamily: "monospace", fontWeight: "bold"}}>{.00042069 * quantity} {props.currencySymbol}</span> for mfers, tinyass unicorns, and based space punks holders. feb. 17th snapshot)
						</div>
					</div>
